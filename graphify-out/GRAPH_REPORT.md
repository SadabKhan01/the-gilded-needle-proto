...
- [[_COMMUNITY_Art Asset Manifest and Curation Plan|Art Asset Manifest and Curation Plan]]
- [[_COMMUNITY_Production Issue Backlog|Production Issue Backlog]]
- [[_COMMUNITY_README|README.md]]
- [[_COMMUNITY_Auberlin Town Map Reference|Auberlin Town Map Reference]]
- [[_COMMUNITY_Grandmother Character Sheet|Grandmother Character Sheet]]
- [[_COMMUNITY_Imported File 2 PDF|Imported File 2 PDF]]
- [[_COMMUNITY_Marielle Character Sheet|Marielle Character Sheet]]
- [[_COMMUNITY_Runtime Reference Exclusion|Runtime Reference Exclusion]]
- [[_COMMUNITY_Spindle Square Overcast Reference|Spindle Square Overcast Reference]]
- [[_COMMUNITY_Spindle Square Sunny Reference|Spindle Square Sunny Reference]]
- [[_COMMUNITY_Bare Home Background|Bare Home Background]]
- [[_COMMUNITY_Home Background Generation Recipe|Home Background Generation Recipe]]
- [[_COMMUNITY_Home Upgrade Props|Home Upgrade Props]]
- [[_COMMUNITY_Runtime Asset Provenance|Runtime Asset Provenance]]
- [[_COMMUNITY_GN-201 Current Home Map|GN-201 Current Home Map]]
- [[_COMMUNITY_GN-604 Home Visual States|GN-604 Home Visual States]]
- [[_COMMUNITY_Household and Family Milestone|Household and Family Milestone]]
- [[_COMMUNITY_Management Vertical Slice|Management Vertical Slice]]
- [[_COMMUNITY_GN-204 Mother Health Schedule|GN-204 Mother Health Schedule]]
- [[_COMMUNITY_GN-208 Pantry Stove and Bed Benefits|GN-208 Pantry Stove and Bed Benefits]]
- [[_COMMUNITY_GN-202 Render Home Items|GN-202 Render Home Items]]
- [[_COMMUNITY_Auberlin District Map|Auberlin District Map]]
- [[_COMMUNITY_Brida Thimm|Brida Thimm]]
- [[_COMMUNITY_Canonical Character Roster|Canonical Character Roster]]
- [[_COMMUNITY_Cleanliness System|Cleanliness System]]
- [[_COMMUNITY_Coffee Service System|Coffee Service System]]
- [[_COMMUNITY_Customer Behavior Archetypes|Customer Behavior Archetypes]]
- [[_COMMUNITY_Day Phase Structure|Day Phase Structure]]
- [[_COMMUNITY_Dignity Craft Family and Gradual Stability|Dignity Craft Family and Gradual Stability]]
- [[_COMMUNITY_Elise Health System|Elise Health System]]
- [[_COMMUNITY_Elise Thimm|Elise Thimm]]
- [[_COMMUNITY_First Ten Quests|First Ten Quests]]
- [[_COMMUNITY_Fair-Wage Hiring System|Fair-Wage Hiring System]]
- [[_COMMUNITY_Household and Home Progression|Household and Home Progression]]
- [[_COMMUNITY_Manufacturing Complete Result|Manufacturing Complete Result]]
- [[_COMMUNITY_Marielle Thimm|Marielle Thimm]]
- [[_COMMUNITY_Order Intake and Fulfillment System|Order Intake and Fulfillment System]]
- [[_COMMUNITY_Twenty to Thirty Minute Player Promise|Twenty to Thirty Minute Player Promise]]
- [[_COMMUNITY_Materials and Procurement Network|Materials and Procurement Network]]
- [[_COMMUNITY_The Gilded Needle Product and Game Design Plan|The Gilded Needle Product and Game Design Plan]]
- [[_COMMUNITY_Production Canon|Production Canon]]
- [[_COMMUNITY_Success Metrics and Narrative Guardrails|Success Metrics and Narrative Guardrails]]
- [[_COMMUNITY_Tailoring Pipeline|Tailoring Pipeline]]
- [[_COMMUNITY_The Seam|The Seam]]
- [[_COMMUNITY_Tomas Thimm|Tomas Thimm]]
- [[_COMMUNITY_First Twenty-Five Minute Tutorial Flow|First Twenty-Five Minute Tutorial Flow]]
- [[_COMMUNITY_Auberlin 1972 Family Story|Auberlin 1972 Family Story]]
- [[_COMMUNITY_Custom Garment Orders|Custom Garment Orders]]
- [[_COMMUNITY_Family Home|Family Home]]
- [[_COMMUNITY_Family Stability|Family Stability]]
- [[_COMMUNITY_Image-Backed Runtime|Image-Backed Runtime]]
- [[_COMMUNITY_Town Navigation|Town Navigation]]
...
## Communities (75 total, 51 thin omitted)

### Community 0 - "Game Design and Art Plan"
Cohesion: 0.07
Nodes (28): 10. Shop systems, 11. Household and home progression, 12. Mother health, 13. Hiring, 14. Map, 15. Characters, 16. First ten quests, 17. Tutorial flow (+20 more)
...
Cohesion: 0.25
Nodes (7): Controls, Files, Next world layer (planned), Production map, Run, The Gilded Needle — Image-Backed Prototype, What's in the prototype
...
### Community 23 - "Art Asset Manifest and Curation Plan"
Cohesion: 0.14
Nodes (13): Art Asset Manifest and Curation Plan, Auberlin townspeople, Curation checklist, Elise portrait sheet, Generation prompt recipes, Home background, Marielle portrait sheet, Open-world Auberlin (+5 more)

### Community 24 - "Production Issue Backlog"
Cohesion: 0.20
Nodes (9): Milestone 0 - foundation and canon, Milestone 1 - management vertical slice, Milestone 2 - household and family, Milestone 3 - town and procurement, Milestone 4 - tailoring depth, Milestone 5 - customers, quests, and staff, Milestone 6 - art, audio, and UX, Milestone 7 - quality and release (+1 more)
...
## Knowledge Gaps
- **168 isolated node(s):** `assert`, `fs`, `path`, `vm`, `root` (+163 more)
